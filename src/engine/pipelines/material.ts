...
export abstract class MaterialPipeline extends Pipeline {
	...
	drawBatch(encoder: GPUCommandEncoder, src: Array<Pawn<SimpleMesh>>, camera: Camera, target: GBuffer) {}
	drawShadowMapBatch(encoder: GPUCommandEncoder, src: Array<Pawn<SimpleMesh>>, light: DirectionalLight, target: ShadowMap) {}
	drawTransparencies(encoder: GPUCommandEncoder, src: Array<Pawn<SimpleMesh>>, camera: Camera, depth: GPUTexture, target: GPUTexture) {}
}
