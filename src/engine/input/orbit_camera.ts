...
import { Camera, QuaternionCamera } from 'engine/camera';
import { multiply, transformPoint, translation } from 'engine/math/transform';

export class EulerOrbitCameraController {
	disabled = false;
	...
	update(dt: number) {
		...
		this.camera.rotate(pitch * dt, yaw * dt, 0);
	...
	onTouchMove = (e: TouchEvent) => {
		...
		this.camera.rotate(dy / -1000, dx / -1000, 0);
		this.update(0);
		this.previousTouch = touch;
	};
...
export class OrbitCameraController {
	...
	constructor(
		private el: HTMLElement,
		public camera: QuaternionCamera,
		public distance: number = 12,
		public target: Point3 = [0, 0, 0],
	) {
		this.gfx = camera.gfx;
